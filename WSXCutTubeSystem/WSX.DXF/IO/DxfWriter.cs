...
using Image = WSX.DXF.Entities.Image;
using Point = WSX.DXF.Entities.Point;
using TextAlignment = WSX.DXF.Entities.TextAlignment;
using Trace = WSX.DXF.Entities.Trace;
