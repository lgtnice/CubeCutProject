...
namespace WSX.DXF
{
		...
		DxfObject
	{
			...
			: base("DOCUMENT")
		{
			...
			this.comments = new List<string> { "Dxf file generated by WSX.DXF https://github.com/haplokuon/WSX.DXF, Copyright(C) 2009-2018 Daniel Carvajal, Licensed under LGPL" };
			this.Owner = null;
