...
namespace WSX.Iges.Entities
{
    public class IgesCubicSolid : IgesFiniteElement
    {
            ...
            : base(IgesTopologyType.CubicSolid)
        {
            ...
            P5P1Control1 = p5P1Control1;
            P6P2Control1 = p6P2Control1;
            P7P3Control1 = p7P3Control1;
            P8P4Control1 = p8P4Control1;
            P5P1Control2 = p5P1Control2;
            P6P2Control2 = p6P2Control2;
            P7P3Control2 = p7P3Control2;
            P8P4Control2 = p8P4Control2;
            P5 = p5;
        ...
        internal static IgesCubicSolid FromDummy(IgesFiniteElementDummy dummy)
        {
            return new IgesCubicSolid(
                ...
                GetNodeOffset(dummy, 24),
                GetNodeOffset(dummy, 25),
                GetNodeOffset(dummy, 26),
                GetNodeOffset(dummy, 27),
                GetNodeOffset(dummy, 28),
                GetNodeOffset(dummy, 29),
                GetNodeOffset(dummy, 30),
                GetNodeOffset(dummy, 31));
        }
    }
}
