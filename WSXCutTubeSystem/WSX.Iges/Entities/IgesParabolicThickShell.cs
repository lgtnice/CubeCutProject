...
{
    public class IgesParabolicThickShell : IgesFiniteElement
    {
        ...
        public IgesParabolicThickShell(
            IgesPoint p1,
            ...
            : base(IgesTopologyType.ParabolicThickShell)
        {
            P1 = p1;
        ...
        internal static IgesParabolicThickShell FromDummy(IgesFiniteElementDummy dummy)
        {
            return new IgesParabolicThickShell(
