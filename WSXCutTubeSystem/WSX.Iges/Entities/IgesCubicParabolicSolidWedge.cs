...
{
    public class IgesCubicParabolicSolidWedge : IgesFiniteElement
    {
        ...
        internal static IgesCubicParabolicSolidWedge FromDummy(IgesFiniteElementDummy dummy)
        {
            return new IgesCubicParabolicSolidWedge(
