...
{
    public class IgesCubicSolidWedge : IgesFiniteElement
    {
        ...
        public IgesPoint P5P2Control1 { get; set; }
        public IgesPoint P6P3Control1 { get; set; }
        public IgesPoint P4P1Control2 { get; set; }
        public IgesPoint P5P2Control2 { get; set; }
        public IgesPoint P6P3Control2 { get; set; }
        ...
        public IgesCubicSolidWedge(
            ...
            IgesPoint p5P2Control1,
            IgesPoint p6P3Control1,
            IgesPoint p4P1Control2,
            IgesPoint p5P2Control2,
            IgesPoint p6P3Control2,
            IgesPoint p4,
            ...
            : base(IgesTopologyType.CubicSolidWedge)
        {
            P1 = p1;
        ...
        protected override void AddNodes()
        {
            ...
            InternalNodes.Add(new IgesNode(P5P2Control1));
            InternalNodes.Add(new IgesNode(P6P3Control1));
            InternalNodes.Add(new IgesNode(P4P1Control2));
            InternalNodes.Add(new IgesNode(P5P2Control2));
            InternalNodes.Add(new IgesNode(P6P3Control2));
